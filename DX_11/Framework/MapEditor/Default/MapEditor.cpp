                     ...
                     _In_ int       nCmdShow)
{
    ...
    CEditorMain* mainEditor = CEditorMain::Create();
...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
    ...
    RECT rc{ 0, 0, MapEditor::g_iWinSizeX, MapEditor::g_iWinSizeY };
