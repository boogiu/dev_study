...
VS_OUT VS_BILLBOARD(VS_IN In)
{
    ...
    float3 objectWorld = mul(float4(0, 0, 0, 1), matWorld[TransformIndex]).xyz;
    ...
    float2 worldScale;
    worldScale.x = length(matWorld[TransformIndex]._11_12_13);
    worldScale.y = length(matWorld[TransformIndex]._21_22_23);
