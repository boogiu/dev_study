...
HRESULT CPlayerStateMachine::Initialize()
{
	...
	auto TREESHKE = m_LayerStates[STATE_LAYER::ACTION]->Add_State<CPlayerState_ShakeTree>("Action_TreeShake_State");
	...
	auto NO_TOOL = m_LayerStates[STATE_LAYER::TOOL]->Add_State<CPlayerState_NoTool>("Tool_NoTool_State");
	...
	m_LayerStates[STATE_LAYER::TOOL]->Excute(NO_TOOL);
