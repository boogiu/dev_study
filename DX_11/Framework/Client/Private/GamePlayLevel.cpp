...
{
	m_pPlayer = Builder::Create_Object({ "GamePlay_Level","GamePlay_GameObject_Player" }).Position({ 560,0,550 }).Build("Player");
	...
	Get_LevelObject<CNpcSpawner>()->Spawn_Npc(L"KK", { 590,0,550 }, "GamePlay_GameObject_NpcTkk");
