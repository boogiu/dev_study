...
#include "Collider.h"
NS_BEGIN(Engine)
class ENGINE_DLL CAABB_Collider :
    public CCollider
{
private:
    CAABB_Collider();
    CAABB_Collider(const CAABB_Collider& rhs);
    virtual ~CAABB_Collider() DEFAULT;
...
public:
    virtual COLLIDER_TYPE Get_ColliderType() override { return COLLIDER_TYPE::AABB; };
